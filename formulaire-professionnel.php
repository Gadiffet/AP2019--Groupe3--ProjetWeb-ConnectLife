...
<body>
    ...
    <form action="" method="post">
        <div class="formulaire">
            ...
            <div class="input">
                Nom de la société <input type="text" name="nom_societe" value=" <?php if (isset($_POST['nom_societe'])){echo $_POST['nom_societe'];} ?>">
            </div>
            <div class="input">
                Poste occupé <input type="text" name="poste_occupe" value=" <?php if (isset($_POST['poste_occupe'])){echo $_POST['poste_occupe'];} ?>">
            </div>        
            <div class="input">
